...
class FoamDictEditor:
    ...
    def __init__(self, foam_dict: str | Path):
        ...
        Args: foam_dict: Path to the OpenFOAM dictionary file
    ...
    def _get_entry_regex( key: str) -> re.Pattern:
        ...
        Args: key: The dictionary key to match
    ...
    def get_value(self, key: str) -> Optional[str]:
        ...
        Args: key: The dictionary key to retrieve
    ...
    def delete_value(self, key: str) -> None:
        ...
        Args: key: The dictionary key to delete
    ...
    def has_key(self, key: str) -> bool:
        ...
        Args: key: The dictionary key to check
    ...
    def parse_value(value: str) -> None | bool | int | float | str:
        ...
        Args: value: The string value to parse
        Returns: Parsed value as None, bool, int, float, or str
        """
    ...
    def load_dict_entries(self) -> dict:
        ...
        Parses key-value pairs from the file, handling comments and converting values to appropriate Python types.
        Returns: Dictionary of parsed entries with keys mapped to their typed values
        """
        text = self._read_file()
    ...
    def overwrite_nu_in_transport_properties(self, new_nu: float) -> None:
        ...
        Args: new_nu: The new kinematic viscosity value
        Raises: KeyError: If 'nu' entry cannot be located in the expected format
        """
        text = self._read_file()
        ...
        pattern = re.compile(
            r"^(nu\s+nu\s+\[\s*0\s+2\s+-1\s+0\s+0\s+0\s+0\s*\]\s+)[0-9.eE+-]+(\s*;)", re.MULTILINE)
        if not pattern.search(text):
