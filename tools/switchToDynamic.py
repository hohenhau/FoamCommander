...
from utilities.fileHandler import get_list_of_files
...
def switch_to_ncc():
    ...
    # Retrieve the relevant stl files
    stl_files = get_list_of_files(TRI_SURFACE_DIR, suffix=".stl", contains="rotating")
